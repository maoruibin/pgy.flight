...
/* package */ class AppDownloadTask {
    ...
    private String getFileName(HttpURLConnection urlConnection) {
        ...
        // http://119.90.20.36/qiniu-app-cdn.pgyer.com/5ab8bd9877599ba712fe1c268d85abcb.apk?e=1472185120
        // &attname=MJWeatherBox-2016-08-23.apk
        // &token=6fYeQ7_TVB5L0QSzosNFfw2HU8eJhAirMF5VxV9G:gUPqv_mbDxARyzS9uxMJA8SEZ6o=&wsiphost=local
        ...
        if (TextUtils.isEmpty(fileName)) {
            ...
            if (attachment != null) {
                ...
                if(!TextUtils.isEmpty(path) && path.endsWith("apk") && path.contains("/")){
                    fileName = path.substring(path.lastIndexOf("/")+1,path.length());
                }else{
                    fileName = String.valueOf(System.currentTimeMillis()).concat(".apk");
                }
            }
        }
