 ...
 */
public abstract class BaseAppListFragment<T,P extends AbsAppListContract.Presenter<T>>
        extends BaseFragment
        implements AppAdapter.AppItemClickListener,
        SwipeRefreshLayout.OnRefreshListener,
        AbsAppListContract.View<T,P>{
    ...
    private void subscribe() {
        instancePresenter().subscribe(subscribeParam());
    }
    ...
    abstract P instancePresenter();

    abstract T subscribeParam();
