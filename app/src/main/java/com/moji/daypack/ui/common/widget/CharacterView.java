package com.moji.daypack.ui.common.widget;
...
public class CharacterView extends View {
    ...
    public CharacterView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.characterViewStyle);
    }

    public CharacterView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.FFTheme_Widget_CharacterView);
    }
