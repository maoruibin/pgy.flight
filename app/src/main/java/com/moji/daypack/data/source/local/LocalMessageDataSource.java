...
import static com.moji.daypack.data.source.local.db.tables.MessageTable.QUERY_ALL_SYSTEM_MESSAGES;
import static com.moji.daypack.data.source.local.db.tables.MessageTable.TABLE_NAME;
import static com.moji.daypack.data.source.local.db.tables.MessageTable.WHERE_ID_EQUALS;
